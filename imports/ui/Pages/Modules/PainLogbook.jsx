...
export default function PainLogbook() {
    ...
    const fillerWords = ["de", "het", "ik", "dat", "er", "me"];
    ...
    return (<div className="container">
        ...
        {renderOptions()}
        {/*<div style={{width: 414, height: 736, border: "solid 2px var(--idewe-blue-dark)", overflow: "hidden", position:"absolute", top:"50", right: "50"}}>
