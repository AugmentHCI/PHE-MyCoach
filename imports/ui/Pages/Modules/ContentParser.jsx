...
function ContentParser(props) {
     ...
     * @param {String} onCorrect The text that needs to be displayed when the user answers correctly
     * @param {String} onIncorrect The text that needs to be displayed when the user answers incorrectly
     */
    ...
    function createImageContent(key, imageUrl, width) {
        ...
        imageUrl.forEach((image, index) => {
            imageHTML.push(<img className="content-image-inline" src={image} width={80 / imageUrl.length + "%"}/>)
        })
        return imageHTML;
    }
    ...
    switch (props.data.type) {
        ...
        case 'Image':
            return createImageContent(props.data.key, props.data.url, props.data.width);
        default:
