...
function ContentParser(props) {
    ...
    function createSortingContent(key, columns, options) {
        let columnHTML = [];
        columns.forEach((column, index) => {
            columnHTML.push(<div key={key+"-"+index} className="content-sorting-column">{column}</div>)
        })
        return (<div className="content-sorting-container">{columnHTML}</div>)
    }
    ...
    switch (props.data.type) {
        ...
        case 'Sort-Exercise':
            return createSortingContent(props.data.key, props.data.columns, props.data.options);
        case 'Image':
