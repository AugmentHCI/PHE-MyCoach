    ...
    function renderMessages() {
        ...
        messageQueue.forEach((message, index) => {
            ...
            if (message.content === "recommendation") { 
                ...
                messages.push(<ChatbubbleInputSummary key={"message-recommendation-inputs"} typeLength={recommendationIndex > 0 ? 0 : 2000} inputs={computeBars(userInput)} codes={codes} highlights={recommendations[recommendationIndex].codeMarkings}/>);
