    ...
    parseUserQuestions() {
        ...
        this.result.forEach(question => {
            ...
            parsedQuestions.push({
                question: question.vraag === "ipadqd1" ? "ipaqd1" : question.vraag,
                answer: question.antwoord.replace("\n", ""),
                questionnaire: question.vraag.split(/([0-9]+)/)[0] === "ipadqd" ? "ipaqd" : question.vraag.split(/([0-9]+)/)[0],
